...
export function ForCommunitiesPageView({ locale }: { locale: OmdalaLanguage }) {
  const legacyContent = audiencePages.communities
  const body = isBilingualLanguage(locale)
    ? getPublicPageBodyCopy('forCommunities', locale)
    : null
