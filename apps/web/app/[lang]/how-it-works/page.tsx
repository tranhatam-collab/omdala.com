...
import { HowItWorksPageView } from "../../how-it-works/HowItWorksPageView"
...
export async function generateMetadata({
  ...
  return buildLocalizedMetadata("howItWorks", language)
}
...
export default async function LocalizedHowItWorksPage({
  ...
  const language = resolveRouteLanguage((await params).lang)
  return <HowItWorksPageView locale={language} />
}
