...
import type { OmAiAccountPreferences, OmAiAccountProfile, OmAiBetaGate, OmAiBillingSubscription, OmAiBillingUsage } from '@omdala/types'
import {
  listMockNodes,
  listMockOffers,
  listMockProofs,
...
export function getAccountBillingSnapshot(): {
  ...
  return {
    profile: {
      ...
      bio: 'Hồ sơ vận hành đang được dùng làm điểm vào chuẩn cho lớp tài khoản và hồ sơ của Om AI.',
    ...
    usage: {
      ...
      remaining: {
        callMinutesToday: OM_AI_FREE_DAILY_CALL_MINUTES - 12,
      },
    },
