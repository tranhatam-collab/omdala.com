...
// ─── Shared-core contracts (Team 2 T2-1 baseline) ───────────────────────

export type WorkspaceType = "family" | "organization" | "school" | "business";
...
export type SharedAppId = "om-ai" | "omniverse" | "omdala-platform";

export interface SharedNotificationRecord {
  id: EntityId;
  userId: EntityId;
