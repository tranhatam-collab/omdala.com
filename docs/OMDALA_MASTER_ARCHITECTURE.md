...
- `omdala.com` public surface links only to `docs.omdala.com` or `app.omdala.com`
- `docs.omdala.com` links only to `app.omdala.com`
- `app.omdala.com` does not link back to external branded surfaces by default

Correct flow:

- `omdala.com` → `docs.omdala.com` → `app.omdala.com`

Incorrect flow:

- `app.omdala.com` → non-OMDALA production surface
- `docs.omdala.com` → non-OMDALA production surface
...
Do not use non-OMDALA domains for auth.
...
Do not introduce new production system services under external domains.
...
- external-domain finance surface
- external-domain trust surface
