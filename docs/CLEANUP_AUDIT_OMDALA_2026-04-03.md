...
**Status**: LEGACY / ARCHIVE SNAPSHOT  
**Use**: Chỉ dùng để tham chiếu audit lịch sử ngày `2026-04-03`, không dùng làm source of truth hiện tại.  
**Canonical replacements**: `PROJECT_CONTEXT_ENGINE.md`, `MASTER_DEV_COMPLETION_PLAN_2026-04-08.md`, `DOCS_SOURCE_OF_TRUTH_INDEX_2026-04-08.md`
...
- legacy mixed-brand build-system document outside approved repo scope

Why:

- this repo is currently locked to OMDALA-only scope
- this file reintroduces mixed-brand and mixed-domain architecture
...
5. remove the mixed-brand document from repo scope
