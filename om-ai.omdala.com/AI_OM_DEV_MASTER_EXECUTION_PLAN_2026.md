...
This is a legacy-transition execution plan.

Current canonical rule:

- `Om AI` = AI human interaction / learning / communication product
- `Om AI` is **not** `OmCode`
- `Om AI` is **not** `Omniverse`
- any mixed `Reality Agent` scope below must be treated as outdated planning context, not current execution ownership

Current source of truth:

1. `AI_OM_SHARED_PLATFORM_DEPENDENCY_STATUS_2026.md`
2. `AI_OM_TEAM_BOUNDARY_AND_DEPENDENCY_MATRIX_2026.md`
3. `../docs/OM_AI_MASTER_DEV_PLAN_2026.md`
...
Phan mo ta ben duoi co gia tri lich su, nhung khong con la product boundary hien tai.

Om AI hien tai phai duoc dinh vi la:

**AI Om = Personal + Family + School + Business Agent OS**

Trong giai doan hien tai, lop uu tien thuc thi la:

### Lop Human Interaction Agent
...
Reality/device/scene/gateway scope da duoc tach khoi Om AI current ownership.
