...
- `Om AI` = AI human call / learning / communication product
- `Om AI` != `OmCode`
- `Om AI` != `Omniverse`
- device / room / scene / automation ownership belongs to `Omniverse`

If any legacy workspace doc conflicts with root canonical docs, follow:
...
## Boundary and Integration Control
