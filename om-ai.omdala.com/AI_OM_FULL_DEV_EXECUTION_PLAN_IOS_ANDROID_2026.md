...
This file was written before the current product split was fully locked.

Current rule:

- Om AI current scope = live interaction, learning, communication, memory, recap, provider routing, and metering
- gateway and physical-control material below is legacy-transition context only
- do not use this file to reintroduce one-app-does-everything scope
...
Xây dựng Om AI thành một sản phẩm AI human interaction đa nền tảng:
...
Gateway hoặc physical-control chỉ còn là bridge context nếu có nhắc bên dưới.
